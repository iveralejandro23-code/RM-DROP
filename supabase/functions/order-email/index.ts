// ROCKSTAR V17.9 — Order email webhook
// Trigger: Supabase Database Webhook on public.orders INSERT.
//
// Required secrets:
// RESEND_API_KEY
// EMAIL_FROM  e.g. "ROCKSTAR <pedidos@tudominio.com>"
...
const money=(v:any)=>new Intl.NumberFormat("es-MX",{
...
Deno.serve(async(req)=>{
  ...
  let newSecret="";
  try{
    newSecret=JSON.parse(Deno.env.get("SUPABASE_SECRET_KEYS")||"{}")["default"]||"";
  }catch(_){}
  const secretKey=newSecret||legacySecret;
